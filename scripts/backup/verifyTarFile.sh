...
source "${SCRIPTS}"/backup/backup_functions.sh
source "${SCRIPTS}"/ctest/ctest_functions.sh
source "${SCRIPTS}"/debugging/debugging_functions.sh
source "${SCRIPTS}"/development/development_functions.sh
source "${SCRIPTS}"/execution/execution_functions.sh
source "${SCRIPTS}"/network/network_functions.sh
source "${SCRIPTS}"/search/search_functions.sh
source "${SCRIPTS}"/sysadmin/sysadmin_functions.sh
source "${SCRIPTS}"/utility/utility_functions.sh
source "${SCRIPTS}"/git/git_functions.sh
